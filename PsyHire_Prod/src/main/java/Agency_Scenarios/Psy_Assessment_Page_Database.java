...
public class Psy_Assessment_Page_Database {
	...
	@FindBy(xpath = "//label[contains(text(),'Psychometric Assessments')]")
	private WebElement Click_on_Psy_Assessments;
	public void Click_On_Psy_Assessments(){Click_on_Psy_Assessments.click();}
...
//	public void Select_One_Questions(){Select_one_questiones.click();}
	...
	@FindBy(xpath = "//label[contains(text(),'Questions (11)')]")
	...
	public Psy_Assessment_Page_Database(WebDriver driver){
