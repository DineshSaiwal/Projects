...
public class Skill_Assessment_Page_Upload {
	...
	public void Upload_Excel_file() throws AWTException, InterruptedException{Click_on_Browse_file.click();
	 ...
	 Utility_Class.Upload_File(Utility_Class.userdir+"\\Required_Files\\All_Qestions_Skills.xlsx");}
	...
	public Skill_Assessment_Page_Upload(WebDriver driver){
