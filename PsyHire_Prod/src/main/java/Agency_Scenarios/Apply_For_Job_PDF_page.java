...
public class Apply_For_Job_PDF_page {
	WebDriver driver = Base_Class.getDriver();
		...
		public void Enter_Name() {Enter_name.sendKeys("Dinesh Saiwal");}
		
		@FindBy(name = "email")
		private WebElement Enter_email;
		public void Enter_Email() {Enter_email.sendKeys("dinesh.saiwal@abc.com");}
