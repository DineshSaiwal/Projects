...
public class Apply_For_Job_PDF_page extends Utility_Class{
	...
	WebDriver driver = Base_Class.getDriver();
		...
		public void Enter_Name() throws IOException {Enter_name.sendKeys(CellData("Job_Apply", 1, 2));}
		
		@FindBy(name = "email")
		private WebElement Enter_email;
		public void Enter_Email() throws IOException {Enter_email.sendKeys(CellData("Job_Apply", 2, 2));}
		
		@FindBy(name = "phone_number")
		private WebElement Enter_phone_number;
		public void Enter_Phone_Number() throws IOException {Enter_phone_number.sendKeys(CellData("Job_Apply", 3, 2));}
		
		@FindBy(xpath = "(//input[@type='search'])[1]")
		private WebElement click_on_Contry_Code;
		public void Click_on_Contry_Code() throws IOException{click_on_Contry_Code.sendKeys(CellData("Job_Apply", 4, 2));	}
		...
		public void Enter_Location() throws IOException {Enter_location.sendKeys(CellData("Job_Apply", 5, 2));}
		
		@FindBy(name = "current_designation")
		private WebElement Enter_current_designation;
		public void Enter_Current_Designation() throws IOException {Enter_current_designation.sendKeys(CellData("Job_Apply", 6, 2));}
		
		@FindBy(name = "experience_in_years")
		private WebElement Enter_experience_in_years;
		public void Enter_Experience_In_Years() throws IOException {Enter_experience_in_years.sendKeys(CellData("Job_Apply", 7, 2));}
		
		@FindBy(name = "experience_in_months")
		private WebElement Enter_experience_in_months;
		public void Enter_Experience_In_Months() throws IOException {Enter_experience_in_months.sendKeys(CellData("Job_Apply", 8, 2));}
		
		@FindBy(name = "notice_period")
		private WebElement Enter_notice_period;
		public void Enter_Notice_Period() throws IOException {Enter_notice_period.sendKeys(CellData("Job_Apply", 9, 2));}
		...
		Utility_Class.Upload_File(Utility_Class.userdir+"\\Required_Files\\Cover Letter.pdf");
		}
		
		@FindBy(xpath = "//div[@role='presentation']")
		private WebElement Upload_Resume_pdf;
		public void Upload_Resume_PDF() throws AWTException, InterruptedException {Upload_Resume_pdf.click();
		Utility_Class.Upload_File(Utility_Class.userdir+"\\Required_Files\\Resume.pdf");
		}
		...
		public  Apply_For_Job_PDF_page(WebDriver driver) {
