...
import Oragnization_Scenarios.Skill_Assessment_Page_Database;
...
public class Skill_Assessment_Database_Validation extends Base_Class{
	ExtentTest test;
		...
		test = extent.createTest("Skill_Assessment_Database_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Organization");
