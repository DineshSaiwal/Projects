...
import Oragnization_Scenarios.Psy_Assessment_Page_Upload;

public class Psy_Assessment_Upload_Validation extends Base_Class{
	ExtentTest test;
 
		@Test 
		void Psy_Assessment_Upload_validation() throws Exception{
			
			
		test = extent.createTest("Psy_Assessment_Upload_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Organization");
		...
		ScreenRecorderUtil.startRecord("Psy_Assessment_Upload_Validation");
		WebDriver driver = getDriver();
		Psy_Assessment_Page_Upload page= new Psy_Assessment_Page_Upload(driver);	
		Login.Organization_Login();
		 ...
		 Thread.sleep(1000);
		 try {page.Click_On_Psy_Assessment();
