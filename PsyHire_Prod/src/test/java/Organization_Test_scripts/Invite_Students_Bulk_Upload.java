...
import Oragnization_Scenarios.Invite_Students_Bulk_Upload_Page;
...
public class Invite_Students_Bulk_Upload extends Base_Class {
	...
	ExtentTest test;
		...
		void Invite_Students_Validation() throws Exception{
			...
			test = extent.createTest("Invite_Students_Bulk_Upload").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Organization");
