...
import Oragnization_Scenarios.Skill_Assessment_Page_Upload;

public class Skill_Assessment_Upload_Validation extends Base_Class{
	ExtentTest test;
	 
		@Test 
		void Skill_Assessment_page_Upload() throws Exception{
			
			
		test = extent.createTest("Skill_Assessment_Upload_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Organization");
		...
		ScreenRecorderUtil.startRecord("Skill_Assessment_Upload_Validation");
		WebDriver driver = getDriver();
		Skill_Assessment_Page_Upload page= new Skill_Assessment_Page_Upload(driver);	
