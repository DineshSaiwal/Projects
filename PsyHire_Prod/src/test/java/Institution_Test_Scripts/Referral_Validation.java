...
import Institution_Scenarios.Referral_Page;
import Base_Package.*;
...
public class Referral_Validation extends Base_Class{
	...
	ExtentTest test;
		...
		void Referral_validation() throws Exception{
			...
			test = extent.createTest("Intitution_Referral_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Institution");
