...
public class Inst_Login_validation extends Base_Class {
	ExtentTest test;
	...
	void Login_Validation() throws Exception{
		...
		test = extent.createTest("PsyHire_Institution_Login").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Institution");
		...
		Institution_Login_Page page= new Institution_Login_Page(driver);	
			...
			Thread.sleep(1000);
			 ...
			 String expectedTitle = "https://app.psyhire.ai/drs_college_of_engineering/dashboard";
