...
import Agency_Scenarios.Skill_Assessment_Page_Create;
...
public class Skill_Assessment_Create_Validation extends Base_Class{
	ExtentTest test;
		...
		test = extent.createTest("Skill_Assessment_Create_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
