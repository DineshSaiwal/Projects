...
import Agency_Scenarios.Apply_For_Job_PDF_page;
...
public class Apply_For_Job_PDF_Validation extends Base_Class{
	...
	void Apply_For_Job_PDF_validation() throws Exception{
		...
		test = extent.createTest("Apply_For_Job_PDF_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
