...
import Agency_Scenarios.Add_Talent_Acquisition_Team_Page;
...
public class Add_Talent_Acquisition_Team_Validation extends Base_Class{
	...
	void Add_Talent_Acquisition_Team_validation() throws Exception{
		...
		test = extent.createTest("Add_Talent_Acquisition_Team_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
