...
import Agency_Scenarios.One_Way_Assessment_Page_Upload;
...
public class One_Way_Assessment_Upload_Validation extends Base_Class{
	ExtentTest test;
		@Test 
		void Agency_One_Way_Assessment_Upload_validation() throws Exception{
			
			
		test = extent.createTest("One_Way_Assessment_Upload_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
