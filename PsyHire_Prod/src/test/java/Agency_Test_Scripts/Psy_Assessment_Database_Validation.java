...
import Agency_Scenarios.Psy_Assessment_Page_Database;
...
public class Psy_Assessment_Database_Validation extends Base_Class{
	ExtentTest test;
		...
		test = extent.createTest("Psy_Assessment_Database_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
