...
import Agency_Scenarios.One_Way_Assessment_Page_Create;
...
public class One_Way_Assessment_Create_Validation extends Base_Class{
	...
	public String Messages;
		...
		test = extent.createTest("One_Way_Assessment_Create_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
