...
import Agency_Scenarios.Psy_Assessment_Page_Create;
...
public class Psy_Assessment_Create_Validation extends Base_Class{
	ExtentTest test;
		...
		test = extent.createTest("Psy_Assessment_Create_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
