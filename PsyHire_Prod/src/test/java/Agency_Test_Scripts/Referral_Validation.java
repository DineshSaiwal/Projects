...
import Agency_Scenarios.Referral_Page;
...
public class Referral_Validation extends Base_Class{
	...
	test = extent.createTest("Agency_Referral_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
