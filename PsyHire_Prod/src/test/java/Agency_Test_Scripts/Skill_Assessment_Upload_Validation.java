...
import Agency_Scenarios.Skill_Assessment_Page_Upload;
...
public class Skill_Assessment_Upload_Validation extends Base_Class{
	...
	public String Messages;
		@Test 
		void Agency_Skill_Assessment_page_Upload() throws Exception{
			
			
		test = extent.createTest("Skill_Assessment_Upload_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
