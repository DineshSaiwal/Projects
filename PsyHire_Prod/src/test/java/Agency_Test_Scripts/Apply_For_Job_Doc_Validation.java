...
import Agency_Scenarios.Apply_For_Job_Doc_page;
...
public class Apply_For_Job_Doc_Validation extends Base_Class{
	...
	void Apply_For_Job_Doc_validation() throws Exception{
		...
		test = extent.createTest("Apply_For_Job_Doc_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
