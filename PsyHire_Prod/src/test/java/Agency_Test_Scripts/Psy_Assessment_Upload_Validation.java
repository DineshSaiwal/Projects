...
import Agency_Scenarios.Psy_Assessment_Page_Upload;
...
public class Psy_Assessment_Upload_Validation extends Base_Class{
	ExtentTest test;
		@Test 
		void Agency_Psy_Assessment_Upload_validation() throws Exception{
			
		test = extent.createTest("Psy_Assessment_Upload_Validation").assignAuthor("Dinesh_Saiwal").assignDevice(browserName).assignCategory("Agency");
